	...
	public static void makePdfs(String pdfPages, String type, String course, String rootDirName){
		...
		if (pdfPages.contains(",")){
        	...
        	for (int i = 0; i < chunks.size(); i++){
        		...
        		try{
        			String outFile = "C:/openchemPdfs/"+course+"/"+rootDirName
		...
		try
        {
            ...
            while (rowIterator.hasNext())
            {
                ...
                if (readingsCell != null || problemsCell != null || solutionsCell != null){
                	new File("C:\\openchemPdfs\\"+course+"\\"+rootDirectoryName).mkdir();
                }
                
                // Readings
                if (readingsCell != null){
	                String readingsString = dataFormatter.formatCellValue(readingsCell);
	                new File("C:\\openchemPdfs\\"+course+"\\"+rootDirectoryName+"\\Readings").mkdir();
                ...
                if (problemsCell != null){
	        		...
	        		new File("C:\\openchemPdfs\\"+course+"\\"+rootDirectoryName+"\\Problems").mkdir();
                ...
                if (solutionsCell != null){
	                ...
	                new File("C:\\openchemPdfs\\"+course+"\\"+rootDirectoryName+"\\Solutions").mkdir();
